          ...
          <div className="max-w-[1920px] mx-auto px-6 md:px-8 lg:px-12 py-12 space-y-8">
            ...
            >
              <div className="flex-1">
                <h1 className="font-orbitron font-bold text-5xl md:text-6xl mb-4 bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(251,191,36,0.5)]">
                  Eagle Nest
                </h1>
                ...
                {paginatedAdvisories.map((advisory, index) => (
                  <motion.div
                    ...
                    className="
                      ...
                      rounded-2xl border border-slate-700/50 shadow-2xl p-6
                    ...
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                      ...
                      <div className="flex-1 space-y-3">
                        <div className="flex items-center space-x-3 flex-wrap gap-2">
                          <span className={`px-3 py-1 rounded-lg text-xs font-bold font-orbitron border ${getCriticalityColor(advisory.criticality)}`}>
                          ...
                          {advisory.date_published && (
                            <span className="text-slate-500 font-rajdhani text-xs">
                              {new Date(advisory.date_published).toLocaleDateString()}
                            </span>
                          )}
                        </div>

                        <h3 className="text-xl font-orbitron font-bold text-white group-hover:text-amber-300 transition-colors duration-300 line-clamp-2">
                          {advisory.title || 'Untitled Advisory'}
                        </h3>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm font-rajdhani">
                          {advisory.affected_product && (
                            <div className="flex items-start">
                              <span className="text-slate-400 min-w-[120px]">Product:</span>
                              <span className="text-white">{advisory.affected_product}</span>
                            </div>
                          )}
                          {advisory.vendor && (
                            <div className="flex items-start">
                              <span className="text-slate-400 min-w-[120px]">Vendor:</span>
                              <span className="text-white">{advisory.vendor}</span>
                            </div>
                          )}
                          {advisory.threat_type && (
                            <div className="flex items-start">
                              <span className="text-slate-400 min-w-[120px]">Threat Type:</span>
                              <span className="text-white">{advisory.threat_type}</span>
                            </div>
                          )}
                        </div>
                        ...
                        {advisory.exec_summary_parts && advisory.exec_summary_parts.length > 0 && (
                          <div className="pt-3 border-t border-slate-700/50">
                            <p className="text-slate-300 text-sm font-rajdhani line-clamp-2">
                              {advisory.exec_summary_parts[0]}
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex md:flex-col gap-2">
                        <Link href={`/admin/eagle-nest/${advisory.advisory_id}`}>
                          <button className="
                            ...
                            bg-amber-600/20 border border-amber-500/30 rounded-lg
                            text-amber-400 hover:bg-amber-600/30 hover:text-amber-300
                            transition-all duration-200 text-sm font-rajdhani
                            hover:scale-105
                          ">
                        ...
                        <button 
                          ...
                          className="
                            flex items-center space-x-2 px-4 py-2
                            bg-red-500/20 border border-red-400/30 rounded-lg
