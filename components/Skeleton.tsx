...
export const SkeletonStatsCard: React.FC = () => (
  <div className="stagger-item backdrop-blur-md bg-gradient-to-br from-slate-800/50 to-slate-900/20 border-2 border-slate-700/40 rounded-lg p-3 shadow-lg shadow-slate-800/20">
    <div className="flex items-center justify-between mb-2">
      <div className="flex-1">
        <div className="h-3 bg-slate-700/70 rounded w-32 mb-2"></div>
      </div>
      <div className="p-1.5 bg-slate-700/50 rounded-lg mr-0">
        <div className="h-4 w-4 bg-slate-700/70 rounded"></div>
      </div>
    </div>
    <div className="space-y-1.5">
      <div className="h-7 bg-slate-700/70 rounded w-16 animate-pulse"></div>
