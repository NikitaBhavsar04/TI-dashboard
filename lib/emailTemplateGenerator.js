...
export function generateCyberThreatEmailTemplate(advisory, customMessage = '') {
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 25px;">
                                <tr>
                                    <td style="background: linear-gradient(135deg, #1e40af, #3b82f6); border-radius: 12px; padding: 25px; text-align: center; border: 1px solid rgba(59, 130, 246, 0.3);">
                                        ...
                                        <a href="${baseUrl}/advisory/${advisory._id}" style="display: inline-block; background: rgba(255, 255, 255, 0.1); color: #fbbf24; padding: 12px 25px; border-radius: 8px; font-weight: 600; font-size: 14px; text-decoration: none; border: 1px solid rgba(255, 255, 255, 0.2); backdrop-filter: blur(10px); font-family: Arial, Helvetica, sans-serif;">
                                            📄 View Full Report
                                        </a>
                                    </td>
                                </tr>
